  ...
  return (
    <div>
      ...
      <AboutUsSingleComponent
        ...
        imgSrc="../../public/images/aboutUs/office.jpg"
      />
      <AboutUsSingleComponent
        ...
        imgSrc="../../public/images/aboutUs/keyboard.jpg"
        icon="../../public/icons/aboutUs/aboutShop.svg"
      />
      <AboutUsSingleComponent
        theme="bg-black text-white"
        ...
        imgSrc="../../public/images/aboutUs/aboutPC00.png"
        icon="../../public/icons/aboutUs/aboutHeart.svg"
      />
      <AboutUsSingleComponent
        theme="bg-white text-black flex-row-reverse"
        ...
        "
        imgSrc="../../public/images/aboutUs/aboutPC2.jpg"
        icon="../../public/icons/aboutUs/aboutStar.svg"
      />
      <AboutUsSingleComponent
        theme="bg-black text-white"
        ...
        "
        imgSrc="../../public/images/aboutUs/aboutPC03.png"
        icon="../../public/icons/aboutUs/aboutDeliver.svg"
      />
      <Comments />
    </div>
  );
